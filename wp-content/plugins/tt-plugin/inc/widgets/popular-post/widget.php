    ...
    class TT_Popular_Post_Widget extends WP_Widget {
        public function __construct() {
            parent::__construct(
                ...
                __('Sixtyninestudio Popular Posts', 'tt-pl-textdomain'), // Name
        ...
        public function widget($args, $instance) {
            ...
            <div class="tt-popular-post">
                ...
                <ul class="nav nav-tabs">
                    <li class="active">
                        <a href="#<?php echo esc_attr($id); ?>_tab-1" data-toggle="tab"><?php esc_html_e('Latest Post', 'tt-pl-textdomain'); ?></a>
                    </li>
                    <li>
                        <a href="#<?php echo esc_attr($id); ?>_tab-2" data-toggle="tab"><?php esc_html_e('Popular Post', 'tt-pl-textdomain'); ?></a>
                    </li>
                </ul>
                ...
                <div class="tab-content">
                                ...
                                while ($the_query->have_posts()) {
                                    ...
                                    <div class="media">
                                        <?php
                                            ...
                                            $image = wp_get_attachment_image_src($thumb_id, 'sixtyninestudio-popular-post-thumb'); // Get img URL.
                                            //
                    ...
                    <div id="<?php echo $id ?>_tab-2" class="tab-pane fade">
                        <?php
                            $qargs = array(
                                'post_type'      => 'post',
                                'meta_key'       => 'sixtyninestudio_post_views_count',
                                'posts_per_page' => $instance['post_limit'],
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <?php if ($instance[ 'post_view' ] == 'yes') { ?>
                                                <span>(<?php echo sixtyninestudio_get_post_views(get_the_ID()) ?>)</span>
                                            <?php } ?>
